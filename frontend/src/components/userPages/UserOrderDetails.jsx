...
//             <button
//               onClick={() => navigate(-1)}
//               className="text-sm font-bold text-gray-500 hover:text-black tracking-tight"
//             >
//               ← Back
//             </button>
//             <button
//               onClick={() => navigate(`/invoice/${order._id}`)}
//               className="text-xs bg-white border border-gray-200 px-4 py-2 rounded-lg font-bold shadow-sm"
//             >
//               🧾 Download Invoice
//             </button>
//           </div>
...
//                 </div>
//                 <span
//                   className={`px-4 py-1.5 rounded-full text-xs font-black border ${STATUS_COLORS[order.status] || "bg-gray-100"}`}
//                 >
//                   {order.status}
//                 </span>
//               </div>
...
//                 <button
//                   onClick={cancelOrder}
//                   className="mt-6 w-full md:w-auto text-xs font-bold text-red-500 border border-red-100 bg-red-50 px-6 py-2 rounded-xl"
//                 >
//                   Cancel Order
//                 </button>
//               )}
...
//                   </span>
//                   <span
//                     className={`text-xs font-black px-2 py-0.5 rounded ${order.paymentStatus === "PAID" ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-700"}`}
//                   >
//                     {order.paymentStatus}
//                   </span>
//                 </div>
...
//                     <button
//                       onClick={handleOnlinePayment}
//                       className="w-full bg-orange-500 text-white font-black py-3 rounded-xl text-sm"
//                     >
...
//                   {user?.username || order.customerName || "Customer"}
//                 </p>
...
//             <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
//               <h3 className="text-xs font-black text-gray-400 uppercase mb-6 tracking-widest">
//                 Order Summary
//               </h3>
