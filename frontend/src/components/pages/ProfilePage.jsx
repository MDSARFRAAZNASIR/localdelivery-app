        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-gray-50 rounded-[40px] p-8 border border-gray-100 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h2 className="font-black text-gray-800 uppercase tracking-tighter">
                {t("Account Details")}
              </h2>
              {!isEditing && (
                <button
            ...
            {error && (
              <div className="mb-4 text-[10px] font-black text-red-600 bg-red-50 p-3 rounded-2xl border border-red-100 uppercase">
                {error}
              </div>
            )}
            {message && (
              <div className="mb-4 text-[10px] font-black text-green-600 bg-green-50 p-3 rounded-2xl border border-green-100 uppercase">
                {message}
              </div>
            )}
